    ...
    <div className='font-mono'>
      <div className={styles.container}>
        ...
        {childrenMenu.length > 0 && (
          <div className='w-[50px] pt-3 bg-container-bg-2 border-r border-container-bg-3 gap-4 flex flex-col items-center'>
            {childrenMenu.map((i) => (
              <div
                onClick={() => {
                  navigate(i.path)
                ...
                key={i.path}
                className={classNames('flex flex-col gap-1 p-1 rounded-md justify-center items-center w-[40px]', { 'bg-grey-3 text-primary': pathname.startsWith(i.path) }, styles.menu_icon, 'hover:bg-grey-3', 'cursor-pointer')}>
